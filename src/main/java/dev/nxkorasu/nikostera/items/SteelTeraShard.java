...
public class SteelTeraShard extends SimplePolymerItem {
    PolymerModelData modelData;
    public SteelTeraShard(Settings settings, Item polymerItem) {
    ...
    public int getPolymerCustomModelData(ItemStack itemStack, @Nullable ServerPlayerEntity player){
        this.modelData = TeraObjects.steelTeraShardModelData;
