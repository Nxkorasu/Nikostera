...
public class GhostTeraShard extends SimplePolymerItem {
    PolymerModelData modelData;
    public GhostTeraShard(Settings settings, Item polymerItem) {
    ...
    public int getPolymerCustomModelData(ItemStack itemStack, @Nullable ServerPlayerEntity player){
        this.modelData = TeraObjects.ghostTeraShardModelData;
